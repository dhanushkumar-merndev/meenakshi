...
function Feedback({ state }: { state: ActionState }) {
  return state.message ? <p className={`rounded-md p-3 text-sm ${state.ok ? "bg-secondary" : "bg-destructive/10 text-destructive"}`}>{state.message}</p> : null;
}
