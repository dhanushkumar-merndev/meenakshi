          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <Select value={role} onValueChange={(v) => setRole(v as string)}>
                ...
                <SelectContent>
                  {["admin", "reception", "ip", "pharmacy"].map((v) => (
      ...
      <DialogContent>
        <form action={action} className="contents">
          ...
          <div className="space-y-4">
            ...
            <div className="grid gap-4 sm:grid-cols-2">
              <div className="space-y-2"><Label>Role</Label><Select value={role} onValueChange={(value) => setRole(value as string)}><SelectTrigger className="w-full"><SelectValue /></SelectTrigger><SelectContent>{["admin", "reception", "ip", "pharmacy"].map((value) => <SelectItem key={value} value={value}>{value}</SelectItem>)}</SelectContent></Select></div>
